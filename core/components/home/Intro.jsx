...
const Intro = () => {
  return (
    <header id="header" className="relative bg-[url('/images/piscina4.jpg')] bg-cover bg-center w-full bg-no-repeat">
      <div className="absolute top-0 left-0 w-full h-full bg-primary bg-opacity-80"></div>
      <div className="relative w-full h-full grid-cols-1 px-5 py-8 md:h-auto rid md:py-0 md:grid-cols-2">
        <Wrapper>
